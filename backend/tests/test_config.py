...
class TestConfigurationSecurity:
    ...
    def test_no_hardcoded_credentials(self):
        ...
        assert (
            "password" not in settings.DATABASE_URL.lower() or "localhost" in settings.DATABASE_URL
        )  # Test database
    ...
    def test_sensitive_fields_not_accessible(self):
        ...
        assert (
            not hasattr(settings, "SMTP_PASSWORD_RAW")
            or getattr(settings, "SMTP_PASSWORD_RAW", None) is None
        )
